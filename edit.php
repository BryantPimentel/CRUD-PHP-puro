<?php
include("db.php");
$nombre= '';  //guardo cada dato ingredado
$apellido= '';
$direccion= '';
$telefono= ''; 
$puesto= '';
...
if  (isset($_GET['id_empleados'])) {
  ...
  if (mysqli_num_rows($result) == 1) {
    ...
    $nombre=$row['nombres'];  //guardo cada dato ingredado
...
if (isset($_POST['update'])) {
  ...
  $query = "UPDATE empleados set nombres = '$nombre', apellidos = '$apellido', direccion = '$direccion', telefono = '$telefono',  fecha_nacimiento= '$fecha', id_puesto = '$puesto' WHERE id_empleados=$id_empleados";  
